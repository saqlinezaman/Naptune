        ...
        <div class="app-auth-container">
           ...
           <!-- register end -->
            ...
            <div class="auth-credentials m-b-xxl">
                ...
                <input type="email" class="form-control m-b-md" id="signInEmail" aria-describedby="signInEmail" placeholder="example@neptune.com" value="<?php if(isset($_SESSION["register-email"])){
